...
public
class CTClear implements CTPacket
{

    public final CTLineType type;

    public
    CTClear(CTLineType type)
    {
        this.type = type;
    }
    ...
    public static
    CTClear fromBytes(DataInputStream dis) throws IOException
    {
        return new CTClear(CTLineType.fromBytes(dis));
    }
