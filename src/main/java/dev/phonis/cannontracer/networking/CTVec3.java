...
public
class CTVec3 implements CTSerializable
{
    ...
    public
    CTVec3(double x, double y, double z)
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public static
    CTVec3 fromBytes(DataInputStream dis) throws IOException
    {
        return new CTVec3(dis.readFloat(), dis.readFloat(), dis.readFloat());
    }
