...
class CTLineManager
{
    ...
    public synchronized
    void forEachLineInCurrentWorld(LineConsumer consumer)
    {
    ...
    private
    List<CTLine> getLinesForWorld(UUID world)
    {
    ...
    public synchronized
    void addArtifacts(CTNewArtifacts ctNewArtifacts)
    {
    ...
    public synchronized
    void addLines(CTNewLines ctNewLines)
    {
    ...
    public synchronized
    void clearByType(CTLineType type)
    {
    ...
    public synchronized
    void clearByTypes(Set<CTLineType> types)
    {
        for (UUID world : this.lineMap.keySet())
        {
            List<CTLine>     lines    = this.lineMap.get(world);
